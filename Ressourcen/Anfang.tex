...
\newcolumntype{B}{X<{\hsize=1.5\hsize\vspace{4pt}}} % Spaltentyp mit Abstand rechts
\newcolumntype{H}{X<{\hsize=1.8\hsize\vspace{4pt}}} % Spaltentyp mit Abstand rechts
\newcolumntype{N}{>{\hsize=.5\hsize\centering\arraybackslash}X} % Spaltentyp mit Abstand rechts
\newcolumntype{O}{>{\hsize=.7\hsize\centering\arraybackslash}X} % Spaltentyp mit Abstand rechts
